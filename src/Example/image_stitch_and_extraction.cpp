...
int main( int argc, char** argv )
{
    ...
    for( std::size_t i = 0; i < image_fov_paths.size(); i++ )
    {
         ...
         *
         *  Marker:
         *      The Marker pattern loaded from tsv marker pattern file
         *      It is generated by the chipimgproc::marker::Loader::from_txt() function
         * 
         *  Mask:
         *      The Marker mask pattern loaded from tsv marker pattern file which masks bits for marker detection
         *      It is generated by the chipimgproc::marker::Loader::from_txt() function.
         * 
         *  Height (µm) of cell:
         ...
         * 
         *  Spacing y of marker:
         *      The spacing (cell counts) between first top-left cell (probe) of each marker along Y axis
         * 
         *  µm to pixel:
         *      The value which is given by manufacturer corresponding to the reader (SUMMIT) hardware, this parameter is used to convert the µm to pixel
         *     
         * 
        ...
        auto marker_regioins = marker_detector(
            ...
            0,                          //  An integral specifying perfect marker pattern mode. Default mode is to use perfect marker pattern, set as 0
            std::cout
            );
