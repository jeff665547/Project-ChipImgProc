/**
 * @file    ChipImgProc/line_detection.hpp
 * @author  Alex Lee, Chia-Hua Chang
 * @brief   LineDetection the rotation angle of image need to be corrected.
 */
#pragma once
#include <cmath>
#include <random>
...
class LineDetection
{
  ...
  public:
    /**
     *  @brief  LineDetection the rotation angle of image need to be corrected.
     *  @details LineDetection the rotation angle of image
